    ...
    <div id="app">
        ...
        <div class="imagen">
            <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                <label><strong class="text-black fs-5 me-4">🚛 ESPERA EN PATIO / ESTACIONAMIENTO</strong></label>
            </div>
        </div>
    ...
    const app = createApp({
        ...
        methods: {
            ...
            login() {
                ...
                if (UserLevel === "Logistica2" || UserLevel === "Admin") {
                ...
                fetch(this.Direccion + accion1 + '&e=' + NB, {
                    ...
                    .then((datosRespuesta => {
                        ...
                        if (datosRespuesta.length == 0) {
                            ...
                            this.TxtEstacionamiento1 = "ESPERA MUELLE";
