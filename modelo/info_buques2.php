...
class PDF extends FPDF
{
    ...
    function Header(){
        ...
        $this->SetXY(90,19);
        $this->Cell(30,5,'INFORME DE BUQUES DESCARGADOS POR MES',0,1,'C');
        ...
        $this->Cell(35,5,"BUQUE", 0, 0);
        $this->Cell(25,5,"MUELLE", 0, 0);
        $this->Cell(22,5,"TORRE", 0, 0);
        $this->Cell(40,5,"CARGA", 0, 0);
        $this->Cell(23,5,"FECHA ATRAQUE", 0, 1);
...
$pdf->AddPage();   
      ...
      while($row = mysqli_fetch_array($result)) {
        ...
        if ($Nombre1 != $Nombre2) { 
            $pdf->SetFont('Arial','',8);
            $pdf->Cell(36,5,$row['buque'], 0, 0);
            $pdf->Cell(26,5,$row['muelle'], 0, 0);
            $pdf->Cell(23,5,$row['torre'], 0, 0);
            $pdf->Cell(40,5,$row['carga'], 0, 0);
            $pdf->Cell(23,5,$row['fecha_entrada'], 0, 1);
        }
