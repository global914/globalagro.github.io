    ...
    <div id="app">
        ...
        <div class="imagen">
            <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                <label><strong class="text-black fs-5 me-4">🚛 DESPACHO</strong></label>
            </div>
        </div>
                            ...
                            <div class="text-center">
                                <table class="table table-hover">
                                    <thead>
                                        ...
                                        <tr>
                                            <th class="table-info">Peso Tara</th>
                                            <td>
                                                <input type="text" v-model="TxtPesoTara1" id="TxtPesoTara1" class="form-control me-1 border-danger" placeholder="Peso Tara" maxlength="50" onKeypress="if (event.keyCode < 45 || event.keyCode > 57) event.returnValue = false;" />
                                            </td>
                                        </tr>
                                        <tr>
                                            <th class="table-info">Nro de Presinto</th>
                                            <td>
                                                <input type="text" v-model="TxtPresinto1" id="TxtPresinto1" class="form-control me-1 border-danger" placeholder="Nro de Presinto" maxlength="50" onKeypress="if (event.keyCode < 45 || event.keyCode > 57) event.returnValue = false;" />
                                            </td>
                                        </tr>
                                    </thead>
                                    <tbody>
    ...
    const app = createApp({
        ...
        methods: {
            ...
            login() {
                ...
                if (UserLevel === "Despachador" || UserLevel === "Admin") {
            ...
            Alert() {
                ...
                let N1 = document.getElementById("TxtPesoTara1");
                let N2 = document.getElementById("TxtPresinto1");
                this.TxtPesoTara1 = ""
                this.TxtPresinto1 = ""
                N1.disabled = false
                N2.disabled = false
                ...
                fetch(this.Direccion + accion1 + '&e=' + NB, {
                    ...
                    .then((datosRespuesta => {
                        ...
                        if (datosRespuesta.length == 0) {
                            ...
                            this.TxtEstacionamiento1 = "PESAJE DE SALIDA";
            ...
            ActualizarRegistro() {
                ...
                let Pes1 = this.TxtPesoTara1;
                let Pre1 = this.TxtPresinto1;
                let N1 = document.getElementById("TxtPesoTara1");
                let N2 = document.getElementById("TxtPresinto1");
                let Id = this.Id1;
                let accion1 = "ActualizarEsta4";
                const fecha = Date.now();
                const hoy = new Date(fecha);
                let fechaA = hoy.toLocaleDateString('es-CL', {
                    timeZone: 'America/Caracas'
                ...
                if (Pes1 == "") { //NOMBRE DEL CHOFER
                    ...
                    Swal.fire({
                        icon: 'error',
                        title: 'GUARDAR',
                        text: 'DEBE Ingresar el Peso Tara!!',
                        footer: ''
                    })
                    return;
                }

                if (Pre1 == "") { //NOMBRE DEL CHOFER

                    Swal.fire({
                        icon: 'error',
                        title: 'GUARDAR',
                        text: 'DEBE Ingresar el Nro de Presinto!!',
                        footer: ''
                    })
                    return;
                }
