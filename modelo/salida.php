                ...
                <div class="modal-dialog modal-dialog-scrollable modal-lg">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            ...
                            <button type="button" class="btn btn-outline-danger" data-bs-dismiss="modal" v-on:click="Alert()">❌ Cerrar</button>
                        </div>
                    </div>
                </div>
            </div>
    ...
    const app = createApp({
        ...
        methods: {
            ...
            login() {
                ...
                if (UserLevel === "Logistica5" || UserLevel === "Admin") {
            ...
            ModalOpcion(h) {
                ...
                fetch(this.Direccion + accion1 + '&e=' + h, {
                        //method:"POST",
                        //body:(e)
                    })
