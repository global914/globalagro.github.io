    ...
    <div id="app">
        ...
        <div class="imagen">
            <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                <label><strong class="text-black fs-5 me-4">🛣 APARCAMIENTOS</strong></label>
            </div>
        </div>
            ...
            <table class="table table-striped table-hover">
                ...
                <tbody>
                    <tr v-for="Usuario in Usuarios" :key="Usuario.id">
                        ...
                        <td><strong>{{Usuario.orden}}</strong></td>
                        <td>
                        ...
                        <div class="text-center">
                            <table class="table table-hover">
                                <thead>
                                    ...
                                    <tr>
                                        <th class="table-info">Orden</th>
                                        <td>
                                            <input type="number" v-model="TxtOrden1" id="TxtOrden1" class="form-control me-1 border-danger" placeholder="Orden" v-on:keypress="limit()" onKeypress="if (event.keyCode < 45 || event.keyCode > 57) event.returnValue = false;" />
                                        </td>
                                    </tr>
                            ...
                            <table class="table table-hover">
                                <thead>
                                    ...
                                    <tr>
                                        <th class="table-info">Orden</th>
                                        <td>
                                            <input type="number" v-model="TxtOrden2" id="TxtOrden2" class="form-control me-1 border-danger" placeholder="Orden" maxlength="2" onKeypress="if (event.keyCode < 45 || event.keyCode > 57) event.returnValue = false;" />
                                        </td>
                                    </tr>
                                </thead>
                                <tbody>
...
<script>
    ...
    const app = createApp({
        ...
        methods: {
            ...
            limit() {
                const input1 = document.getElementById('TxtOrden1').value;
                const input2 = document.getElementById('TxtOrden2').value;
                const maxLength = 1;

                // Si el valor excede la longitud máxima, se recorta
                if (input1.length > maxLength) {
                    document.getElementById('TxtOrden1').value = "";
                }
                if (input2.length > maxLength) {
                    document.getElementById('TxtOrden2').value = "";
                }
            },
            ...
            SalvarRegistro() {
                ...
                let Ord1 = this.TxtOrden1;
                let accion1 = "InsertarA";
                ...
                if (Esp1 == "") {
                    ...
                    Swal.fire({
                        icon: 'error',
                        title: 'GUARDAR',
                        text: 'DEBE INGRESAR EL NOMBRE DEL APARCAMIENTO!!',
                        footer: ''
                    })
                    return;
                }
                    ...
                    .then((datosRespuesta3 => {
                        ...
                        if (datosRespuesta3.success == 2) {
                            Swal.fire({
                                icon: 'error',
                                title: 'DUPLICADO',
                                text: 'YA EXISTE UN REGISTRO EN ESE ORDEN !!',
                                footer: ''
                            })
                        }
                ...
                fetch("../controlador/base.php?accion1=" + accion1 + '&e=' + e, {
                    ...
                    .then((datosRespuesta2 => {
                        ...
                        if (typeof datosRespuesta2[0].success === 'undefined') {
                            ...
                            this.TxtOrden2 = this.Usuarios2.orden;
            ...
            ActualizarRegistro() {
                ...
                let Ord1 = this.TxtOrden2;
                let ID1 = document.getElementById("Id1").value;
                let accion1 = "ModificarA";
