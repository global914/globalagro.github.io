    ...
    <div id="app">
        ...
        <div class="imagen">
            <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                <label><strong class="text-black fs-5 me-4">📑 INFORME DE UNIDADES</strong></label>
            </div>
        </div>
            ...
            <div class="col-2 card border-primary" id="Contenedor" style="width: 18rem;">
                <div class="modal-dialog text-center">
                    <div class="mt-3">
                        <div class="modal-content">
                            <div class="col-14">
                                <label><strong>Unidades Despachadas por Mes</strong></label>
                                <div>
                                    <h1 id="L-1">📄</h1>
                                </div>
                                <div class="input-group mb-3">
                                    <span class="input-group-text border-primary" id="basic-addon1">🗓</span>
                                ...
                                <div class="input-group mb-3">
                                    <button type="button" class="btn btn-outline-primary" title="Informe PDF" v-on:click="Imprimir()">🖨 Previsualizar</button>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    const app = createApp({
        ...
        methods: {
            ...
            Imprimir() {
                ...
                var URL = "info_unidades2.php?fecha1=" + Fecha1 + "&fecha2=" + Fecha2;
