...
class PDF extends FPDF
{
    ...
    function Header(){
        ...
        $this->SetXY(90,19);
        $this->Cell(30,5,'INFORME DE UNIDADES TRASEGADAS POR MES',0,1,'C');
        ...
        $this->Cell(15,5,"ORDEN", 0, 0);
        $this->Cell(35,5,"CHOFER", 0, 0);
        $this->Cell(25,5,"EMPRESA", 0, 0);
        $this->Cell(35,5,"CARGA", 0, 0);
        $this->Cell(25,5,"PESO BASCULA", 0, 0);
        $this->Cell(20,5,"PESO FINAL", 0, 0);
        $this->Cell(25,5,"FECHA TRASE.", 0, 1);
...
$pdf->AddPage();   
      ...
      $query = "SELECT * FROM trasegado WHERE diat>='$Dia1' and mest='$Mes1' and anot='$Ano1' and diat<='$Dia2' and mest='$Mes2' and anot='$Ano2'";
      ...
      while($row = mysqli_fetch_array($result)) {
        $pdf->SetFont('Arial','',8);
        $pdf->Cell(15,5,$row['placa'], 0, 0);
        $pdf->Cell(15,5,$row['orden'], 0, 0,'C');
        $pdf->Cell(35,5,$row['chofer'], 0, 0);
        $pdf->Cell(25,5,$row['empresa'], 0, 0);
        $pdf->Cell(35,5,$row['carga'], 0, 0);
        $pdf->Cell(25,5,$row['peso1'], 0, 0,'C');
        $pdf->Cell(20,5,$row['peso2'], 0, 0,'C');
        $pdf->Cell(25,5,$row['fechat'], 0, 1,'C');
